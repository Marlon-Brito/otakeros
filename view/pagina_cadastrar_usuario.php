...
<body class="min-h-screen bg-gradient-to-b from-stone-950 to-stone-900 text-white text-base font-[Inter]">
    ...
    <main class="flex flex-col mt-5 justify-center items-center md:my-0 md:grid md:grid-cols-2">
        <div class="min-w-3xs max-w-[300px] mx-auto">
            <a href="?page=dados_usuarios" id="btn__voltar" class="block p-1 mt-5 border-1 border-stone-500 text-stone-500 w-20 text-center mx-auto hover:bg-stone-500 hover:text-stone-900 xl:text-xl xl:px-2 duration-500 ease-in-out">Voltar</a>
            ...
            <form class="flex flex-col items-center justify-center" action="?page=salvar_usuario" method="post" enctype="multipart/form-data">
                ...
                <div class="flex mt-4 justify-center">
                    ...
                    <input type="text" name="nome" id="cNome" placeholder="Digite seu nome" class="bg-white text-black py-1 px-2 focus:outline-none sm:text-lg sm:w-xs xl:w-md xl:text-xl xl:py-2 xl:px-4" required autofocus>
                </div>

                <div class="flex mt-4 justify-center">
                    <i class="bi bi-123 bg-linear-to-r from-amber-300 to-orange-400 text-black p-1 text-xl xl:px-2 xl:text-2xl" title="Idade"></i>
                    <input type="number" name="idade" id="cIdade" placeholder="Digite sua idade" class="bg-white text-black py-1 px-2 focus:outline-none sm:text-lg sm:w-xs xl:w-md xl:text-xl xl:py-2 xl:px-4" required>
                </div>
                ...
                <div class="flex mt-4 justify-center">
                    ...
                    <input type="email" name="email" id="cEmail" placeholder="Digite seu e-mail" class="bg-white text-black py-1 px-2 focus:outline-none sm:text-lg sm:w-xs xl:w-md xl:text-xl xl:py-2 xl:px-4" required>
                </div>
                ...
                <div class="flex mt-4 justify-center">
                    ...
                    <input type="password" name="senha" id="cSenha" placeholder="Digite sua senha" class="bg-white text-black py-1 px-2 focus:outline-none sm:text-lg sm:w-xs xl:w-md xl:text-xl xl:py-2 xl:px-4" required>
                </div>
