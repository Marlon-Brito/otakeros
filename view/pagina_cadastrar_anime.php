...
<body class="min-h-screen bg-gradient-to-b from-stone-950 to-stone-900 text-white text-base font-[Inter]">
    ...
    <main class="flex flex-col mt-5 justify-center items-center md:my-0 md:grid md:grid-cols-2">
        <div class="min-w-3xs max-w-[300px] mx-auto">
            <a href="?page=dados_animes" id="btn__voltar" class="block p-1 mt-5 border-1 border-stone-500 text-stone-500 w-20 text-center mx-auto hover:bg-stone-500 hover:text-stone-900 xl:text-xl xl:px-2 duration-500 ease-in-out" >Voltar</a>

            <h1 class="font-[Bebas_Neue] text-2xl text-amber-400 text-center border-y border-amber-400 mt-5 sm:text-3xl sm:p-2 xl:text-4xl">Cadastro de Anime</h1>

            <!-- Formulário de Cadastro de Anime -->
            <form class="flex flex-col items-center justify-center" action="?page=salvar_anime" method="post" enctype="multipart/form-data">
                <div class="flex flex-col w-60">
                    <img src="../assets/imgs/icone-quadro.png" id="anime__icone" class="rounded-full w-25 h-25 my-2 mx-auto xl:w-50 xl:h-50 xl:my-4" title="Imagem">

                    <div class="flex flex-col items-center">
                        <label for="cImagem" id="label_arquivo" class="text-amber-400 sm:text-lg xl:text-xl text-center">Escolha a imagem do anime:</label>
                        <!-- Pré-visualização da imagem do anime -->
                        <input type="file" name="imagem" id="cImagem" onchange="previewImagem()" class="text-center cursor-pointer border-1 border-stone-500 text-stone-500 mt-4 py-1 px-2 hover:text-black hover:bg-stone-500 xl:py-2 xl:px-4 xl:text-xl duration-500 ease-in-out w-60 sm:w-xs xl:w-md" required>
                    </div>
                </div>
                ...
                <div class="flex mt-4 justify-center">
                    ...
                    <input type="text" name="nome" id="cNome" class="bg-white text-black py-1 px-2 focus:outline-none sm:text-lg sm:w-xs xl:w-md xl:text-xl xl:py-2 xl:px-4" placeholder="Digite seu nome" autofocus required>
                </div>
                ...
                <div class="flex mt-4 justify-center">
                    ...
                    <textarea name="descricao" id="cDescricao" rows="3" placeholder="Digite sua descrição" class="bg-white text-black py-1 px-2 focus:outline-none sm:text-lg sm:w-xs xl:w-md xl:text-xl xl:py-2 xl:px-4 resize-none" required></textarea>
                </div>
