<?php
    ...
    // Começa o cadastro de usuário caso os dados tenham sido enviados via o formulário (post)
    if (isset($_POST["btn_enviar"])) {
        ...
        if (!empty($erros)) {
            ...
            header("Location: ../../index.php?page=cadastrar_usuario");
            exit;
        }
        ...
        if (inserirUsuario($pdo, $nome, $idade, $email, $senha, '')) {
            ...
            header('Location: ../../index.php?page=dados_usuarios&cadastro=ok');
            exit;
        // Erro no cadastro
        } else {
            $_SESSION['erros_cadastro'] = ['Erro ao cadastrar usuário.'];
            header("Location: ../../index.php?page=cadastrar_usuario&cadastro=erro");
            exit;
        }
    }
?>