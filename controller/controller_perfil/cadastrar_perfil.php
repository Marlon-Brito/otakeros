...
<body>
    <a href="../../index.php" id="btn__voltar">Voltar</a>

    <section class="form">
        <!-- Formulário de Cadastro do Perfil do Usuário -->
        <form class="formulario" action="./salvar_perfil.php" method="post" enctype="multipart/form-data">
